...
function aw_setup() {
	...
	register_nav_menus(
		array(
			...
			'menu_home_top' => esc_html__( 'Menu Home Top', 'aw' ),
			'menu_footer_1' => esc_html__( 'Menu Footer 1', 'aw' ),
			'menu_footer_2' => esc_html__( 'Menu Footer 2', 'aw' ),
            
			'menu_new_footer_1' => esc_html__( 'Menu New Footer 1', 'aw' ),
			'menu_new_footer_2' => esc_html__( 'Menu New Footer 2', 'aw' ),
			'menu_new_footer_3' => esc_html__( 'Menu New Footer 3', 'aw' ),
			'menu_new_footer_4' => esc_html__( 'Menu New Footer 4', 'aw' ),
			'menu_new_footer_5' => esc_html__( 'Menu New Footer 5', 'aw' ),
		)
	);
...
function aw_scripts() {
    ...
    wp_enqueue_style( 'custom-bootstrap', get_template_directory_uri() . '/css/bootstrap.custom.min.css', array(), null, 'all' );
    wp_enqueue_script( 'bootstrap-js', get_template_directory_uri() . '/js/bootstrap/js/bootstrap.min.js', array('jquery'), null, true );
    
    wp_enqueue_style( 'aw-multistiwch-css', get_template_directory_uri() . '/css/multi-switch.min.css', array(), time() );
    wp_enqueue_script( 'aw-multiswitch-js', get_template_directory_uri() . '/js/multi-switch.js', array(), _S_VERSION, false );
    
    wp_enqueue_style( 'aw-home-css', get_template_directory_uri() . '/css/maintest.css', array(), time() ); 
	   ...
	   //wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/css/bootstrap/css/bootstrap.min.css', array(), null, 'all' );
        // wp_enqueue_style( 'aw-main', get_template_directory_uri() . '/css/main.min.css' );
		...
		wp_enqueue_script( 'aw-popup', get_template_directory_uri() . '/js/popup.js', array(), _S_VERSION, true );
        ...
        wp_enqueue_style( 'icon-bootstrap', get_template_directory_uri() . '/css/bootstrap-icons.css', array(), null, 'all' );
...
add_action('get_menu_image', 'my_get_thumbnail_image_src', 10, 1);

function my_get_thumbnail_image_src( $slug ) {
    $page_id = get_id_by_slug( $slug );
    $f = get_field('ikona_menu', $page_id);
    echo '<img src="'.$f['url'].'" alt="'.$f['alt'].'"/>';
}
...
function get_profile_picture_url($user_id, $size = 'thumbnail') {
    $attachment_id = get_user_meta($user_id, 'profil_picture', true);
